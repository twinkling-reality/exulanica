...
generator will write: 28 record kinds with integer geometry, 76 declared parameters, four
...
**Parameters.** 76 are declared, at the cascade levels city (4), district (8), block (13), lot (1),
