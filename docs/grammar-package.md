...
generator will write: 27 record kinds with integer geometry, 74 declared parameters, four
...
**Parameters.** 74 are declared, at the cascade levels city (4), district (8), block (13), lot (1),
building (22) and face (26). All but one are `derive`: the reading stage derives a value per
