...
generator will write: 28 record kinds with integer geometry, 77 declared parameters, four
...
**Parameters.** 77 are declared, at the cascade levels city (4), district (9), block (13), lot (1),
