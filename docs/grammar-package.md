...
generator will write: 27 record kinds with integer geometry, 72 declared parameters, four
...
**Parameters.** 72 are declared, at the cascade levels city (4), district (8), block (13), lot (1),
