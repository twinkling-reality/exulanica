...
record of nothing. The module line is kept because a worktree can shadow another checkout's
package and the reading would then be about the wrong tree. Every value below came back identical
