...
The scene worker writes a projection with the pose, placement and gate receipts. Every scene
published without that stage has none, and its first graph read in every fresh process still
rebuilds the placement from every point map.
