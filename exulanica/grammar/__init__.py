...
``exulanica.selection``. It may import ``exulanica.materials``, ``exulanica.canonical``,
``exulanica.errors`` and ``exulanica.env`` and nothing else in this repository. A generator that
cannot construct a citation cannot return one, however it is later changed by somebody who never
read this sentence.
