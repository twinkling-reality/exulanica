"""World styles and the protected source media they are applied over.
...
browser, Settings, or Companion request cannot move a region or rewrite an evidence binding. The
style routes adapt an existing frontend recipe, so their bodies accept camelCase aliases beside
snake_case.

The authored world shares the ``/world`` prefix and lives in its own modules, over the edit bodies
and transaction in :mod:`exulanica.api.world_edit` and the version document in
:mod:`exulanica.api.world_version_document`: reviewed assets in
:mod:`~exulanica.api.routes.world_assets`, reviewed behaviours in
:mod:`~exulanica.api.routes.world_behaviours`, alternate versions in
:mod:`~exulanica.api.routes.world_versions`, environment instances in
:mod:`~exulanica.api.routes.world_environments`, authored objects in
:mod:`~exulanica.api.routes.world_objects` and compositions in
:mod:`~exulanica.api.routes.world_compositions`.
"""
