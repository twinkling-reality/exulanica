...
``mode``, ``speed_mm_per_s``
    ``parked``, ``leaving``, ``driving`` or ``arriving``, and the speed over the last second.
``synthetic``
...
from exulanica.traffic.catalogs import TrafficCatalogs
