 ...
 * `docs/evaluation/2026-09-15-visual-gate-key-reconciliation.json` is the retained statement of it.
...
export const GATE_KEY_SET_VERSION = 'exulanica.visual-gate-keys/v1';
